...
void LLVMContext::addModule(Module *M) {
  sys::CondScopedLock locked(pImpl->mutexOwnedModules);
...
setInlineAsmDiagnosticHandler(InlineAsmDiagHandlerTy DiagHandler,
                              void *DiagContext) {
  sys::CondScopedLock locked(pImpl->mutexDiagHandler);
...
unsigned LLVMContext::getMDKindID(StringRef Name) const {
  ...
  sys::CondScopedLock locked(pImpl->mutexCustomMDKindNames);
